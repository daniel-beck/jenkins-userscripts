// ==UserScript==
// @name        Jenkins Role Strategy Role Assignment Enhancer
// @author      https://github.com/daniel-beck
// @downloadURL https://raw.github.com/daniel-beck/jenkins-userscripts/master/Jenkins_Role_Strategy_Role_Assignment.user.js
// @description Enhancement of Jenkins Role Strategy plugin 'Assign Roles' dialog
...
// @include     http://*/role-strategy/assign-roles
// @include     http://*/jenkins/role-strategy/assign-roles
// @version     1.0
// @grant       none
...
jQuery(document).ready(function(){
    jQuery.noConflict();
    jQuery('#projectRoles .pane-header:nth-child(n+3)').rotateTableCellContent();
    jQuery('#globalRoles .pane-header:nth-child(n+3)').rotateTableCellContent();
